    ...
    <div className='screenSize'>
      <div className='d-flex flex-column justify-content-center banner mt-5 mt-lg-4'>
        ...
        <div className='row justify-content-around  banner-info p-3'>
          <div className=' col-12 col-md-6 p-1 p-md-3 d-flex gap-3 gap-md-5 align-items-center align-items-md-start banner-info-data'>
          ...
          <div className='col-12 col-md-6 p-1 p-md-3 banner-info-details'>
            <p className='banner-info-details-para p-0 mb-2'>Our on-demand EV charging services make sure that EV owners remain free of worries.
