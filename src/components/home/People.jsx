...
const People = () => {
    ...
    return (
        <div className='people screenSize p-2 p-md-3'>
            <div className='people-content d-flex flex-column-reverse flex-md-row  gap-3 align-items-end justify-content-between'>
                <p className='people-content-para text-center text-md-start m-0'>Our vision is to create a <span>sustainable future.</span></p>
                <h2 className='people-content-heading text-center text-md-start '>Why People Love Us.</h2>
            ...
            <div className='row justify-content-center justify-content-md-evenly  text-center'>
                ...
                {
                    data.map((item, index) =>
                        <div className={`col-6 col-md-2 d-flex flex-column gap-2 align-items-center border-2   ${index === 0 ? "" : "border-start"}`}>
